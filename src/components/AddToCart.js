  ...
  return (
    <View style={styles.bottomItems}>
      <View style={styles.bottomIcon}>
        <Image style={styles.icon} source={require('../assets/common/Icon_kf.png')}/>
        <Text style={styles.iconText}>客服</Text>
      </View>
      <View style={styles.bottomIcon}>
        <Image style={styles.icon} source={require('../assets/common/Icon_gz.png')}/>
        <Text style={styles.iconText}>收藏</Text>
      </View>
      <View style={styles.bottomIcon}>
        <Image style={styles.icon} source={require('../assets/common/Icon_gwc.png')}/>
